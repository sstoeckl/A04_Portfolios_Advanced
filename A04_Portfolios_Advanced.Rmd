...
capm <- cbind (names,rbind(CAPM.TP,CAPM.minvar,CAPM.qu,CAPM.qu2))
...
bs.portf <- cbind(baseline.returns.xts,portfolio.returns.maxret$Ra,
                  portfolio.returns.minvar$Ra,
                  portfolio.returns.qu$Ra,
                  portfolio.returns.qu2$Ra)

colnames(bs.portf) <- c("S&P500","Tangency Portfolio", "MinVar Portfolio", "QU RA=1 Portfolio", "QU RA=5 Portfolio")
...
names <- c("Tangency Portfolio", "MinVar","QU RA=1", "QU RA=5")

sigma.mu <- cbind(names,sigma,mu)
