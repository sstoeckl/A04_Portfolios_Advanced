...
```{r}
bt_maxret <- 
optimize.portfolio.rebalancing(R=stocks.returns.xts,
                               portfolio=portf_maxret, optimize_method="ROI",
...
stockselection <- c("MMM", "AAPL", "WMT", "KO", "ADBE", "MCD", "PEP", "AMZN", "YUM", "MSFT")
...
tq_get(get = "stock.prices", from = "2000-01-01", to =
"2019-08-31") %>%
tq_transmute(adjusted, periodReturn, period = "monthly",
col_rename = "returns SP500")
monthly_returnsSP500
```

```{r}
# Calculate the rolling mean monthly
rollmeanSP500 <- rollmean(monthly_returnsSP500[,
"returns SP500"], 2)
rollmeanSP500
```
...
```{r}
 ...
 colnames(R) <- c("MMM", "AAPL", "WMT", "KO", "ADBE", "MCD", "PEP", "AMZN", "YUM", "MSFT")
 funds <- colnames(R)
...
```{r}
stockselection_4 <- c("MMM", "AAPL", "WMT", "KO", "ADBE", "MCD", "PEP", "AMZN", "YUM", "K", "^GSPC")
#Get the prices of the stocks
stock.prices_4 <- stockselection_4 %>%
  tq_get(get  = "stock.prices", from = "2015-01-01",to = "2020-10-01") %>%
  group_by(symbol)
...
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 1], main = "3M Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 1] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 2], main = "Apple Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 2] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 3], main = "Walmart Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 3] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 4], main = "Coca-Cola Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 4] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 5], main = "Adobe Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 5] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 6], main = "McDonald´s Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 6] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 7], main = "Pepsi", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 7] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 8], main = "Amazon", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 8] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 9], main = "YUM! Brands Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 9] ~ stock.returns.monthly_xts_4[, 11])))
plot.default(x = stock.returns.monthly_xts_4[, 11], y = stock.returns.monthly_xts_4[, 10], main = "Kellogg Company Regression", xlab = "Index Returns", ylab = "Stock Returns", abline(lm(stock.returns.monthly_xts_4[, 10] ~ stock.returns.monthly_xts_4[, 11])))
```
